        ...
        <thead>
            <tr>
                ...
                <th style="width: 10%; text-align: left; border: solid 1px #900C3F; background: #900C3F; color: #FFFFFF;">
                    <span style="color: #FFFFFF;">FECHA DE NACIMIENTO </span>
                </th>                <th style="width: 10%; text-align: left; border: solid 1px #900C3F; background: #900C3F; color: #FFFFFF;">
                    <span style="color: #FFFFFF;">NIVEL ACADEMICO </span>
                </th>
            </tr>
        </thead>
        <tbody>
