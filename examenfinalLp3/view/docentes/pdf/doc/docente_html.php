<page backtop="10mm" backbottom="10mm" backleft="20mm" backright="20mm">
    <page_header>
        <table style="width: 100%; border: solid 1px black;">
            <tr>
                <td style="text-align: left; width: 33%">Listado de docente</td>
    ...
    <table style="width: 80%; border: solid 1px #5544DD; border-collapse: collapse" align="center">
        <thead>
            <tr>
                ...
                <th style="width: 15%; text-align: left; border: solid 1px #900C3F; background: #900C3F; color: #FFFFFF;">
                    <span style="color: #FFFFFF;">Especialidad</span>
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td style="width: 55%; text-align: left; border: solid 1px #900C3F">
                        <?=$row['nombre'] ?>
                    </td>
