    ...
    <section class="intro">
        <div class="container">
            ...
            <div class="mb-3">
                ...
                <a href="/view/matricula/pdf/matricula.php" class="btn btn-info">Imprimir</a>
            </div>
                ...
                <table id="myTabla" class="table table-striped mb-0">
                    ...
                    <?php foreach ((array) $rows as $row) { ?>
                        <tr>
                            ...
                            <td><?=$row['nombre']?></td>
                            <td><?=$row['apellido']?></td>
                            <td><?=$row['curso']?></td> <!-- Cambié 'cursonombre' por 'curso' -->
                            <td><?=$row['fecha']?></td>
                            <td>
        ...
        <table class="table table-striped mb-0" style="font-size: 1.50rem;">
            <thead>
                <tr>
                    ...
                    <th colspan="3" scope="col">CURSO</th> <!-- Cambié 'curso_nombre' por 'curso' -->
                </tr>
            </thead>
            <tbody>
            <?php foreach ($rows as $row) { ?>
                <tr>
                    ...
                    <td colspan="4"><?=$row['curso']?></td> <!-- Cambié 'curso_nombre' por 'curso' -->
                </tr>
            <?php } ?>
            </tbody>
        </table>
