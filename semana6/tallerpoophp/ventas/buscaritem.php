<?php
    ...
    if($action == 'ajax'){
        ...
        $sFields = " 
        `articulos`.`idArticulo`,`articulos`.`descripcion`,round(`articulos`.`precioventa`,0) as 
        precioventa,round(`articulos`.`precioventa`,0) as precioventa";
                    ...
                    ?>
                        <tr>
                            ...
                            <td class='text-center'>
                                ...
                                onclick="agregar('<?php echo $idConcepto ?>')">
