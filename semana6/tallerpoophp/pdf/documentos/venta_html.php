    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        ...
        ?>
            <tr>
                ...
                echo $cantidad; ?></td>
                <td class='<?php echo $clase;?>' style="width: 60%; text-align: left"><?php echo 
                $concepto;?></td>
                <td class='<?php echo $clase;?>' style="width: 15%; text-align: right"><?php 
                echo $precio_venta_f;?></td>
                <td class='<?php echo $clase;?>' style="width: 15%; text-align: right"><?php 
                echo $precio_total_f;?></td>
            </tr>
        <?php 
            $nums++;
        }
        ...
        <tr>
            ...
            <td style="width: 15%; text-align: right;"> <?php echo 
            number_format($subtotal,0);?></td>
        </tr>
        <tr>
            <td colspan="3" style="width: 85%; text-align: right;">IVA (<?php echo IMPUESTO; 
            ?>)% G.; </td>
            <td style="width: 15%; text-align: right;"> <?php echo 
            number_format($total_iva,0);?></td>
        </tr>
        <tr>
            <td colspan="3" style="width: 85%; text-align: right;">TOTAL G.; </td>
            <td style="width: 15%; text-align: right;"> <?php echo 
            number_format($total_factura,0);?></td>
        </tr>
    </table>

    <br><br><br>
    <div style="font-size:11pt;text-align:center;font-weight:bold">Gracias por su 
    preferencia!</div>  
